...
public class BitmapFilter {
    ...
    public static Bitmap changeStyle(Bitmap bitmap, int styleNo, Object... options) {
        if (styleNo == GRAY_STYLE) {
            ...
            if (options.length < 1) {
                return new BlurFilter(5).transform(bitmap);
            }
            return new BlurFilter((Integer) options[0]).transform(bitmap);
            ...
            return new BlockFilter().transform(bitmap);
            ...
            return LightFilter.changeToLight(bitmap, (Integer) options[0], (Integer) options[1],
                    (Integer) options[2]); // centerX, centerY, radius
